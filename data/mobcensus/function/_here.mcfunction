...
$execute store result score #n mobcensus if entity @e[type=#mobcensus:cap_mobs, distance=..$(radius)]
...
$execute as @e[type=#mobcensus:cap_mobs, distance=..$(radius), sort=nearest] run function mobcensus:_find_emit
